...
#         # Model's pre-processing logic here.
...
# Allow localhost for development and add your production frontend domain if needed.
CORS(
    app,
    resources={r"/*": {"origins": ["http://localhost:4028", "https://your-frontend-domain.com"]}},
